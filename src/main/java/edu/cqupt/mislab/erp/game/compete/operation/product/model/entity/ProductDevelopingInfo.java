...
@Entity
@Table
public class ProductDevelopingInfo implements Serializable {
    ...
    @Basic(optional = false)
    private Boolean continueResearch;//当前周期是否继续进行产品研发
    ...
    public boolean equals(Object o){
        ...
        ProductDevelopingInfo that = (ProductDevelopingInfo) o;
