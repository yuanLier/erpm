...
public class TransportManagerController {
    ...
    @PutMapping
    public WebResponseVo<TransportBasicVo> updateTransportBasicInfo(@Exist(repository = GameTransportBasicInfoRepository.class)
    ...
    @PutMapping("/close")
    public WebResponseVo<TransportBasicVo> closeTransportBasicInfo(@Exist(repository = GameTransportBasicInfoRepository.class)
                                                                   @RequestParam Long transportBasicId) {
