...
@Entity
@Table
public class MarketDevelopingInfo implements Serializable {
    ...
    @Basic(optional = false)
    private Boolean continueResearch;//当前周期是否继续进行市场开发
    ...
    public boolean equals(Object o){
        ...
        MarketDevelopingInfo that = (MarketDevelopingInfo) o;
